...
public interface IAdminDomainRepository
{
    ...
    Task<IEnumerable<AdminMatriculaListItemDto>> GetMatriculasAsync(CancellationToken cancellationToken = default);
    Task<IEnumerable<AdminImparticionListItemDto>> GetImparticionesAsync(CancellationToken cancellationToken = default);
}