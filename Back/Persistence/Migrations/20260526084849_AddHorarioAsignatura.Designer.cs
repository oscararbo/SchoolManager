...
namespace Back.Api.Persistence.Migrations
{
    ...
    [Migration("20260526084849_AddHorarioAsignatura")]
    partial class AddHorarioAsignatura
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back.Api.Domain.Entities.HorarioAsignatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AsignaturaId", "DiaSemana", "HoraInicio")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.ToTable("HorariosAsignaturas");
                });
